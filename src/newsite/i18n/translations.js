...
const en = {
  ...
  'pricing.mostPopular': 'Most Value',
  'pricing.perMonth': ' / month',
  'pricing.setupFee': '+ one off setup fee',
  'pricing.essential.feature1': 'Standard digital menu',
  'pricing.essential.feature2': 'Standard QR codes for every table',
  'pricing.essential.feature3': 'High-quality photos for every dish',
  'pricing.essential.feature4': 'Available in Georgian, English, and Russian',
  'pricing.signature.feature1': 'Everything in the Basic plan',
  'pricing.signature.feature2': 'Up to 10 dishes in 3D',
  'pricing.signature.feature3': 'Custom-designed digital menu',
  'pricing.signature.feature4': 'Custom QR codes for every table',
  'pricing.signature.feature5': 'Priority support for updates',
  'pricing.signature.feature6': 'Exclusive access to new features',
  'pricing.bespoke.feature1': 'Everything in the Essential plan',
  'pricing.bespoke.feature2': 'Unlimited 3D dishes',
  'pricing.bespoke.feature3': 'Fully custom design',
  'pricing.bespoke.feature4': 'Multi-location system design and support',
  'pricing.footnote':
...
const ka = {
  ...
  'pricing.mostPopular': 'საუკეთესო ღირებულება',
  'pricing.perMonth': ' / თვეში',
  'pricing.setupFee': '+ ერთჯერადი დაყენების საფასური',
  'pricing.essential.feature1': 'სტანდარტული ციფრული მენიუ',
  'pricing.essential.feature2': 'სტანდარტული QR კოდები ყველა მაგიდისთვის',
  'pricing.essential.feature3': 'მაღალი ხარისხის ფოტოები ყველა კერძისთვის',
  'pricing.essential.feature4': 'ქართული, ინგლისური და რუსული ენები',
  'pricing.signature.feature1': 'ყველაფერი Basic პაკეტიდან',
  'pricing.signature.feature2': '10-მდე კერძი 3D ფორმატში',
  'pricing.signature.feature3': 'ინდივიდუალური ციფრული მენიუ',
  'pricing.signature.feature4': 'ინდივიდუალური QR კოდები ყველა მაგიდისთვის',
  'pricing.signature.feature5': 'პრიორიტეტული მხარდაჭერა ცვლილებებზე',
  'pricing.signature.feature6': 'ექსკლუზიური წვდომა ახალ ფუნქციებზე',
  'pricing.bespoke.feature1': 'ყველაფერი Essential პაკეტიდან',
  'pricing.bespoke.feature2': 'ულიმიტო კერძები 3D ფორმატში',
  'pricing.bespoke.feature3': 'სრულად ინდივიდუალური დიზაინი',
  'pricing.bespoke.feature4': 'მრავალფილიალიანი სისტემის დაპროექტება და მხარდაჭერა',
  'pricing.footnote':
...
const ru = {
  ...
  'pricing.mostPopular': 'Лучшая ценность',
  'pricing.perMonth': ' / месяц',
  'pricing.setupFee': '+ разовая плата за установку',
  'pricing.essential.feature1': 'Стандартное цифровое меню',
  'pricing.essential.feature2': 'Стандартные QR коды для каждого столика',
  'pricing.essential.feature3': 'Качественные фотографии для каждого блюда',
  'pricing.essential.feature4': 'Доступно на грузинском, английском и русском',
  'pricing.signature.feature1': 'Всё из пакета Basic',
  'pricing.signature.feature2': 'До 10 блюд в 3D',
  'pricing.signature.feature3': 'Индивидуальный дизайн цифрового меню',
  'pricing.signature.feature4': 'Индивидуальные QR коды для каждого столика',
  'pricing.signature.feature5': 'Приоритетная поддержка при обновлениях',
  'pricing.signature.feature6': 'Эксклюзивный доступ к новым функциям',
  'pricing.bespoke.feature1': 'Всё из пакета Essential',
  'pricing.bespoke.feature2': 'Неограниченное количество блюд в 3D',
  'pricing.bespoke.feature3': 'Полностью индивидуальный дизайн',
  'pricing.bespoke.feature4': 'Проектирование и поддержка многофилиальной системы',
  'pricing.footnote':
