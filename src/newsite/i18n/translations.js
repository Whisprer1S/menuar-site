...
const en = {
  ...
  'pricing.essential.feature2': 'Custom QR codes for your tables',
  'pricing.essential.feature3': 'Georgian, English and Russian',
  'pricing.essential.feature4': 'Photos for every dish',
...
const ka = {
  ...
  'pricing.essential.feature1':
    'თქვენი სრული მენიუ, ობიექტზე მორგებული დიზაინით',
  'pricing.essential.feature2': 'ინდივიდუალური QR კოდები თქვენი მაგიდებისთვის',
  'pricing.essential.feature3': 'ქართული, ინგლისური და რუსული',
  'pricing.essential.feature4': 'ფოტოები ყველა კერძისთვის',
  'pricing.essential.feature5': 'ფასებისა და ტექსტის განახლებებს ჩვენ ვუზრუნველვყოფთ',
  'pricing.signature.blurb':
...
const ru = {
  ...
  'pricing.essential.feature1': 'Ваше полное меню, оформленное под ваше заведение',
  'pricing.essential.feature2': 'Индивидуальные QR коды для ваших столов',
  'pricing.essential.feature3': 'Грузинский, английский и русский',
  'pricing.essential.feature4': 'Фотографии для каждого блюда',
  'pricing.essential.feature5': 'Обновление цен и текста берём на себя',
  'pricing.signature.blurb':
